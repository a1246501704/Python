...
def handle_parse(sql_l,sql_dic):
    ...
    :return:
    '''
    print('sql_l is : \033[41;1m%s\033[0m sql_dic is : \033[41;1m%s\033[0m' %(sql_l,sql_dic))
    tag=False
    for item in sql_l:
    ...
    print('form in the handle_parse sql_dic is \033[43;1m%s\033[0m' %sql_dic)
    return sql_dic
...
def where_parse(where_l): #['id>','4','and','id','<10'] --> ['id>4','and','id<10']
    ...
    print('form in the where_parse res is \033[43;1m%s\033[0m' % res)
    return res
...
# select * from db1.emp where id>1 and name='alex' limit 3
# select * from db1.emp where name like a1
# select * from db1.emp where id> 4 and id <10;
# select * from db1.emp where name like 李 or id < 4
# select * from db1.emp where name like 李 or id <= 4
