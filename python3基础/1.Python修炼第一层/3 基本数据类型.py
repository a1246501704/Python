...
msg='hello'
age=18
print(name+msg+str(age))  # egonhello18  使用str将age变量的值转换成字符串
print(name*10)  # 重复10次
...
# print(hobbies)
# print(hobbies.split()[0]) # 先切分成一个列表再取
...
dict1={'2a':2,'1b':3,'3c':8,'5d':4}  
print(sorted(dict1))               # ['1b', '2a', '3c', '5d']
